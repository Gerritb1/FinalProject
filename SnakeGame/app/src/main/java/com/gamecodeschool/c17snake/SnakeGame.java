...
import java.util.Random;
    ...
    class SnakeGame extends SurfaceView implements Runnable, Game {
        ...
        public void callConstructors(Context context, Point size) {
            ...
            // Call the constructors of our game objects using the Singleton pattern
            ...
            // Initialize and call the Bomb object
            ...
            bombInitialization(context, size);
        }
        ...
        public void bombInitialization(Context context, Point size) {
            // Work out how many pixels each block is
            int blockSize = size.x / NUM_BLOCKS_WIDE;
            mNumBlocksHigh = size.y / blockSize;

            // Initializing the bomb
            mBomb = Bomb.getBomb(context,
                    new Point(NUM_BLOCKS_WIDE,
                            mNumBlocksHigh),
                    blockSize);

            // Spawn the bomb immediately after initialization
           // mBomb.spawn();
        }
        ...
        public void update() {
            if (!mPaused) {
                ...
                // Check if the score is divisible by 4 and spawn the bomb
                if ((mScore > 0) && (mScore % 1== 0) && !mBomb.isSpawned()) {
                    mBomb.spawn();
                }

                // Update the bomb logic
                updateBomb();
        ...
        public void updateBomb() {
            ...
            if (mSnake.bigCheckDinner(mBomb.getLocation())) {
               // mBomb.hide();
                ...
                // Grow the snake body segment by 3
                mSnake.grow(1);
            }
        }
        // Refactored, this is for the poison apple
